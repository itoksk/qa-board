...
function testRepresentativeGenerationFull() {
  ...
  try {
    ...
    console.log(`\n${testQuestions.length}件のテスト意見を追加しました`);
    ...
    if (result.success) {
      console.log('\n✅ 生成成功');
      console.log('処理された意見数:', result.results.processedCount);
      ...
      representatives.forEach((rep, i) => {
        ...
        console.log(`   元意見ID数: ${rep.sourceIds ? rep.sourceIds.length : 0}`);
